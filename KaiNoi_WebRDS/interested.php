  ...
  <body>
    <div class="page">
      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
          <h3 class="wow-outer"><span class="wow slideInUp"><br>"ณ ตอนนี้ คุณคือ คนที่มีรหัส ที่สามารถใช้เข้าร่วมโครงการนำร่อง kainoi.net นี้ได้"</span></h3>
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2;">
                                                ...
                                                <h4><p>พวกเรายินดีอย่างยิ่งที่จะมีคุณเป็นส่วนหนึ่งใน kainoi.net</p>
                                                <p>ที่จะส่งผ่านรูปแบบเว็บแอพพลิเคชั่นครั้งแรกในประเทศไปสู่เพื่อนๆของคุณครับ</p>
                                                <p> คุณรู้สึกอย่างไรกับโครงการนำร่องครั้งนี้</p></h4>
                               <div class="fa-align-center">
                                <form action="#" id="contact-form">	<br>
                                        <button type="button" class="button button-primary button-winona wow fadeIn" onclick="window.location.href='not_interestcode.php'">ไม่สนใจเข้าร่วมโครงการ</button>&nbsp;
                                        <button type="button" class="button button-primary button-winona wow fadeIn" onclick="window.location.href='getcode.php'">สนใจเข้าร่วมโครงการ</button>
                                </form>
                               </div>
        </div>
        </div>
