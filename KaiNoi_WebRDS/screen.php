...
setcookie($cookie_rds, "thailand2019_screen", time() + 3600000, '/');
...
$(document).ready(function(){
        ...
        <div class="container">
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2;">
                          ...
                          <h4><p>ยินดีต้อนรับสู่ kainoi.net กรุณาเลือกคำตอบที่ถูกต้องที่สุด หากไม่แน่ใจให้เลือกคำตอบที่คิดว่าถูกต้องที่สุด</p></h4> <br>
                             <form id="regForm" method="POST" action="checkscreen.php">
		   <!-- progressbar -->
                        <!--  <ul id="progressbar">
                         ...
                         <ul id="progressbar">
                          ...
                          <li><div class="progress">
                           ...
                           <li><div class="progress">
                                     <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width:30%">
                                       30% Complete 
                                     </div>
                                   </div><hr class="new"><br></li>
                          <li><div class="progress">
                         ...
                         <li><div class="progress">
                          ...
                          <li><div class="progress">
                                     <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:60%">
                                       60% Complete 
                                     </div>
                                   </div><hr class="new"><br></li>
                          <li><div class="progress">
                                     <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:65%">
                                       65% Complete 
                                     </div>
                                   </div><hr class="new"><br></li>
                          <li><div class="progress">
		   ...
		   <!-- fieldsets --><?php // echo "เบอร์โทรศัพท์มือถือของคุณ" .$_SESSION["mobilephone"]."ได้ใช้รหัส : " . $_SESSION["rds_code"]."นี้ในการตอบแบบสอบถามคัดกรอง";?>
    <fieldset class= "qs1"  >
  ...
  <fieldset class= "qs1">
      <h3 style=" text-align: left;"><span style="white-space: pre;">คุณรู้จักคนที่ให้</span>
      <span style="white-space: pre;">รหัส (5 หลัก) </span>
      <span style="white-space: pre;">แก่คุณหรือไม่</span></h3>
      
        <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.รู้จัก<input type="radio" id="ELKNOW_a" name="ELKNOW" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.ไม่รู้จัก<input type="radio" id="ELKNOW_b" name="ELKNOW" value="2">
        <span class="checkmarkins12"></span></label>
     ...
     <br>
	    <input type="button" name="previous" style="float: left;" class="previous action-button" value="ก่อนหน้า" />
		     ...
		     <fieldset class= "qs1">
      <h3 style=" text-align: left;"><span style="white-space: pre;">คนที่ให้รหัส (5 หลัก)</span>
      <span style="white-space: pre;">แก่คุณได้</span>
      <span style="white-space: pre;">เข้าร่วมโครงการนี้ด้วย</span>
       <span style="white-space: pre;">ใช่ หรือ ไม่</span></h3>

      
        <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.ใช่<input type="radio" id="ELRECPART_a" name="ELRECPART" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.ไม่ใช่<input type="radio" id="ELRECPART_b" name="ELRECPART" value="2">
        <span class="checkmarkins12"></span></label>
        
        <label class="containerins12" style="text-align: left;">3.ไม่รู้<input type="radio" id="ELRECPART_c" name="ELRECPART" value="3">
        <span class="checkmarkins12"></span></label>
 ...
 <fieldset class= "qs1">
      <h3 style=" text-align: left;"><span style="white-space: pre;">คนที่ให้รหัส (5 หลัก) </span>
      <span style="white-space: pre;">แก่คุณเป็น </span>
        <span style="white-space: pre;">ชายที่มีเพศสัมพันธ์กับชาย </span>
         <span style="white-space: pre;">หรือเป็น</span>
          <span style="white-space: pre;">สาวประเภทสอง</span></h3>

        <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.เป็นชายที่มีเพศสัมพันธ์กับชาย<input type="radio" id="ELRECMSM_a" name="ELRECMSM" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.เป็น สาวประเภทสอง<input type="radio" id="ELRECMSM_b" name="ELRECMSM" value="2">
        <span class="checkmarkins12"></span></label>
        
        <label class="containerins12" style="text-align: left;">3.ไม่ใช่ทั้งชายที่มีเพศสัมพันธ์กับชาย หรือ สาวประเภทสอง<input type="radio" id="ELRECMSM_c" name="ELRECMSM" value="3">
        <span class="checkmarkins12"></span></label>
        
        <label class="containerins12" style="text-align: left;">4.ไม่รู้<input type="radio" id="ELRECMSM_d" name="ELRECMSM" value="4">
        <span class="checkmarkins12"></span></label>
...
<fieldset class= "qs1">
      <h3 style=" text-align: left;"><span style="white-space: pre;">คุณเคยเข้าร่วม</span>
      <span style="white-space: pre;">โครงการนี้แล้ว</span>
      <span style="white-space: pre;">หรือไม่</span></h3>
      
        <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.เคยเข้าร่วมแล้ว<input type="radio" id="ELDUP_a" name="ELDUP" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.ไม่เคยเข้าร่วม<input type="radio" id="ELDUP_b" name="ELDUP" value="2">
        <span class="checkmarkins12"></span></label>
     ...
     <br>
        ...
        <fieldset class= "qs1">
      <h3 style=" text-align: left;"><span style=" white-space: pre;">คุณได้รับรหัส</span>
       <span style=" white-space: pre;">(5 หลัก) มากี่วันแล้ว </span>
      <span style="white-space: pre;">(ใส่เลข 0 </span>
      <span style="white-space: pre;">หากได้รับวันนี้)</span></h3>

      
        <hr class="new">
			   <br>
          <input name="ELCOUP" id="ELCOUP"  min="0" max="90" maxlength="2" type="text" maxlength="2" class="form-control" style="opacity: 5; border-radius: 15px;  width: 250px;height: 40px; font-size: 20px;">
     ...
     <br>
	    <input type="button" name="previous" style="float: left;" class="previous action-button" value="ก่อนหน้า" />
			  <input type="button" name="next" style="float: right;" class="next action-button" value="ต่อไป" />
					 ...
					 <fieldset class= "qs1">
      <span style="text-align: left; white-space: pre; font-weight: bold;"></span>
     ...
     $(document).ready(function() {
      $(".datepicker").Zebra_DatePicker({ format: "d-m-y" }); 
    	...
    	case 0:
				...
				break;
				case 1:
					if(($("input[name='ELKNOW']:checked").length === 0)){
					alert('กรุณาเลือกคำตอบ!');
						return false;
					}
					return true;
				break;
				case 2:
					if(($("input[name='ELRECPART']:checked").length === 0)){
						alert('กรุณาเลือกคำตอบ!');
						return false;
					}
					return true;
				break;
     case 3:
					if(($("input[name='ELRECMSM']:checked").length === 0)){
						alert('กรุณาเลือกคำตอบ!');
						return false;
					}
					return true;
				break;
   case 4:
					if(($("input[name='ELDUP']:checked").length === 0)){
			alert('กรุณาเลือกคำตอบ!');
						return false;
					}
					return true;
				break;
      case 5:
							var x = document.forms["regForm"]["ELCOUP"].value;
							if (x == "") {
							 	alert('กรุณาตอบคำถาม!');
							  return false;
							}
             ...
             $("#NATION_e").click(function(){
              ...
              $("#NATION_f").click(function(){
                 ...
                 $(document).ready(function(){
                   ...
                   $("#ELCOUP").keypress(function(event){
