...
<body class="top-header">
    ...
    <div class="top-bar bg-dark " id="top-bar">
        <div class="container">
         ...
         <center><h3><b style="color: #F90C53;">VIEW</b>Pay</h3></center>
     ...
     <?php
                      ...
                      $sql_allc = "select count(cvalue)as c1,cvalue,used_date from tbecoupon group by cvalue,used_date HAVING used_date  is null";
                      $result_allc = $conn_rds->query($sql_allc);
                      $num_rows = mysqli_num_rows($result_allc);
                        ...
                        <table class="GeneratedTable">
                          ...
                          <tbody>
                           <?php
                            while ($row_allc = $result_allc->fetch_assoc()) {
                               echo "<tr>";
                                   echo '<td>' . $row_allc['cvalue'];'</td>';
                                   echo '<td>' . $row_allc['c1'];'</td>';
                              echo "</tr>";
                            }
                           ?>
                          </tbody>
