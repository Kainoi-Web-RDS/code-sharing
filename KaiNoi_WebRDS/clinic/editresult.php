...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        <div class="container">
          <center><h3>CODE kainoi.net <b style="color: #FF0000;"><?php echo $LABNUMBER;?> </b> </h3></center>
          <?php
          if($conn_rds->connect_error) {
           ...
           $sql = "select * from tbresult where LABNUMBER ='$LABNUMBER'";
           $result = $conn_rds->query($sql) ;
           $num_rows = mysqli_num_rows($result);
           $row_sr = $result->fetch_assoc();
           
           /*$BMVLRES =$row_sr['BMVLRES'];
           
          
           if($BMVLRES =="" or $BMVLRES === NULL)
           {
            $VL=3;
           }
           elseif($BMVLRES >= '3'){
            ...
            <form   class="form"  name="Reg_result" method="post" action="code_result.php" onSubmit="JavaScript:return fncSubmit();">
                 <div class="table-responsive">          
                     <table class="table">
                       ...
                       <tbody>
                           <div  id="ifhiv3" style="  padding-left: 15px; padding-top: 15px;  background: linear-gradient(-60deg, rgb(7, 151, 255) 0%, rgb(255, 254, 252) 0%, rgb(113, 201, 252) 100%);  border-radius: 6px ; border: 3px solid #000000;">
                               
                                  <label style="text-align: left"><b>Final HIV result</b></label>&nbsp;
                                        <label  class="containerins12" style="text-align: left;">POSITIVE <input type="radio" id="BMHIVRES_a" name="BMHIVRES" value="1"  <?php if($row_sr['BMHIVRES']=="1") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">NEGATIVE<input type="radio" id="BMHIVRES_b" name="BMHIVRES" value="2" <?php if($row_sr['BMHIVRES']=="2") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                       
                                         <label class="containerins12" style="text-align: left;">INCONCLUSIVE<input type="radio" id="BMHIVRES_c" name="BMHIVRES" value="3" <?php if($row_sr['BMHIVRES']=="3") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                           ...
                           <div style="padding-left: 15px; padding-top: 15px; padding-bottom: 15px;  border-radius: 6px ; border: 3px solid #000000;">
                                  ...
                                  <label style="text-align: left"><b>Viral load result</b></label>&nbsp;
                                         <div id="ifNo1">
                                                    โปรดระบุ <input style="padding-left: 8px;opacity: 5; border-radius: 20px; height: 35px;"  type="text" id="BMVLRES_OTH" name="BMVLRES_OTH" value="<?php  $BMVLRES_OTH = $row_sr['BMVLRES_OTH']; echo $BMVLRES_OTH; ?>" ><span>&nbsp;&nbsp;copies/mL</span>
                                         </div>
                           ...
                           <div style="padding-left: 15px; padding-top: 15px; border-radius: 6px ; border: 3px solid #000000;">
                                  ...
                                  <label style="text-align: left"><b>Syphilis result</b></label>&nbsp;
                                        <label  class="containerins12" style="text-align: left;">REACTIVE <input type="radio" id="Syphilis_a" name="Syphilis" value="1" <?php if($row_sr['Syphilis']=="1") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">NONREACTIVE<input type="radio" id="Syphilis_b" name="Syphilis" value="2" <?php if($row_sr['Syphilis']=="2") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                       
                                         <label class="containerins12" style="text-align: left;"> INDETERMINATE<input type="radio" id="Syphilis_c" name="Syphilis" value="3" <?php if($row_sr['Syphilis']=="3") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                           ...
                           <div style="padding-left: 15px; padding-top: 15px; border-radius: 6px ; border: 3px solid #000000;">
                                  ...
                                  <label style="text-align: left"><b>HBsAg Result</b></label>&nbsp;
                                        <label  class="containerins12" style="text-align: left;">Positive<input type="radio" id="HB_a" name="HB" value="1" <?php if($row_sr['HB']=="1") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">Negative<input type="radio" id="HB_b" name="HB" value="2"<?php if($row_sr['HB']=="2") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                       
                                         <!-- <label class="containerins12" style="text-align: left;"> INDETERMINATE<input type="radio" id="HB_c" name="HB" value="3" <?php if($row_sr['HB']=="3") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>-->
                           ...
                           <div style="padding-left: 15px; padding-top: 15px; border-radius: 6px ; border: 3px solid #000000;">
                                  ...
                                  <label style="text-align: left"><b>Anti-HCV Result</b></label>&nbsp;
                                        <label  class="containerins12" style="text-align: left;">Positive<input type="radio" id="HC_a" name="HC" value="1"<?php if($row_sr['HC']=="1") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">Negative<input type="radio" id="HC_b" name="HC" value="2" <?php if($row_sr['HC']=="2") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                       
                                       <!--  <label class="containerins12" style="text-align: left;"> INDETERMINATE<input type="radio" id="HC_c" name="HC" value="3" <?php if($row_sr['HC']=="3") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>-->
                           ...
                           <div style="padding-left: 15px; padding-top: 15px; border-radius: 6px ; border: 3px solid #000000;">
                                  ...
                                  <label style="text-align: left"><b>RTRI Result</b></label>&nbsp;
                                        <label  class="containerins12" style="text-align: left;">Recent<input type="radio" id="Recency_a" name="Recency" value="1"<?php if($row_sr['Recency']=="1") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">Long term<input type="radio" id="Recency_b" name="Recency" value="2"<?php if($row_sr['Recency']=="2") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                       
                                               <label  class="containerins12" style="text-align: left;">INCONCLUSIVE<input type="radio" id="Recency_c" name="Recency" value="3"<?php if($row_sr['Recency']=="3") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
                                      
                                       <label class="containerins12" style="text-align: left;">INVALID<input type="radio" id="Recency_d" name="Recency" value="4"<?php if($row_sr['Recency']=="4") { echo "checked" ;} ?> >
                                       <span class="checkmarkins12"></span></label>
