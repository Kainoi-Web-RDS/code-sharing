...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        ...
        <br>
        <br>
          <center><h2><b style="color: #FF0000;"></b>หมายเลขโทรศัพท์ และ รหัสไม่ตรงกัน</h2></center> <br>
           <center>
           <button type="button" name="button"  class="buttong" onclick="window.location.href='select.php'">กลับไปหน้าหลัก</button>
           </center>
         </div>
        <br>
        <br>
