    ...
    <section class="bg-grey" id="service">
        <div class="container">
          <center><h3>CODE kainoi.net <b style="color: #FF0000;"><?php echo $BMRECID;?> </b> </h3></center>
            <form   class="form"  name="Reg_bm" method="post" action="code_accept.php" onSubmit="JavaScript:return fncSubmit();">
                 <div class="table-responsive">          
                     <table class="table">
                       ...
                       <tbody>
                         <tr>
                                   <span style="text-align: left; white-space: pre; font-weight: bold;">ขอคำยินยอม</span>
                                   <span style="text-align: left; white-space: pre; font-weight: bold;">เจาะเลือด</span>
                         </tr>
                          <tr>
                             <label  class="containerins12" style="text-align: left;">1.	ยินดี<input type="radio" id="BMCONS_a" name="BMCONS" value="1">
                            <span class="checkmarkins12"></span></label>
                           
                            <label class="containerins12" style="text-align: left;">2.	ไม่ยินดี<input type="radio" id="BMCONS_b" name="BMCONS" value="2">
                            <span class="checkmarkins12"></span></label>
                          </tr>
                           <tr>
                                   <br>
                                   <span style="text-align: left; white-space: pre; font-weight: bold;">ชนิดของเลือด</span>
                         </tr>
                          <tr>
                             <label  class="containerins12" style="text-align: left;">1.	VENOUS WHOLE BLOOD  <input type="radio" id="BMSPX_a" name="BMSPX" value="1">
                            <span class="checkmarkins12"></span></label>
                           
                            <label class="containerins12" style="text-align: left;">2.	พลาสม่า หรือ ซีรั่ม<input type="radio" id="BMSPX_b" name="BMSPX" value="2">
                            <span class="checkmarkins12"></span></label>
                            
                              <label class="containerins12" style="text-align: left;">3.	CAPILLARY BLOOD<input type="radio" id="BMSPX_c" name="BMSPX" value="3">
                            <span class="checkmarkins12"></span></label>
                          </tr>
                       </tbody>
                     </table>
