...
$BMRECID = $_SESSION["BMRECID"];
          ...
          error_reporting( error_reporting() & ~E_NOTICE );
           $sql = "select * from tbanswer where RDSCODE ='$BMRECID'";
...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        <div class="container">  <br>
           ...
           <br>
           <br>
          <center><h2>CODE kainoi.net <b style="color: #FF0000;"><?php echo $BMRECID;?> </b>บันทึกเข้าระบบเรียบร้อย </h2></center> <br>
           <center>
                <?php
                                            
                                            if($STATUS_LAB ==2){
                                                  $sql_t500 = "select  BMRETEL1,T500 from tblab where BMRECID = '" . $BMRECID . "'";
                                                 ...
                                                 /*$mobilephoneEX = decode($ck_tel,"w-e-b-r-d-s");
                                                  ...
                                                  if($ck_t500 == NULL){
                                                    /////////////////////////////////
                                                                                   ...
                                                                                   $sql_t.= "WHERE BMRECID='$BMRECID'";
                                                                                   $result = $conn_rds->query($sql_t);
                                                                                   
                                    
	                                       $sql_i = "INSERT INTO tbpayqueue (mnumber,pay_for,pay_value,req_date,paid_date) VALUES ('" . $ck_tel . "','" . $pay_type ."'," . $pay_value . ",NOW(),NOW())";
                                        $result_i = $conn_rds->query($sql_i);
