...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        ...
        <br>
        <br>
          <center><h2>CODE kainoi.net <b style="color: #FF0000;"><?php echo $LABNUMBER; unset($_SESSION["LABNUMBER"]); ?> </b>บันทึกผลการตรวจเข้าระบบเรียบร้อย </h2></center> <br>
           <center>
           <button type="button" name="button"  class="buttong" onclick="window.location.href='../klab/selects.php'">กลับไปหน้าแรก</button>
 ...
 function fncSubmit()
{
    ...
    <script>
      ...
      $("#BMCONS_b").click(function(){
      $("#ifNo1").show();
      $("#ifNo2").hide();
      /*$("#BMTESTDATE").val('');
      $("#BMSPX_a").checked==false;
      $("#BMSPX_b").checked==false;
      $("#BMSPX_c").checked==false;*/
     });
