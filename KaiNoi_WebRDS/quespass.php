  ...
  <body>
    <div class="page">
      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
          <h3 class="wow-outer"><span class="wow slideInUp"><br><?php //echo $rdscode; ?></span></h3>
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2;">
                                               ...
                                               <h3><font color='#000000'>ขอขอบคุณที่สละเวลาตอบแบบสอบถามของโครงการ</h3>
                                 <h3><font color='#000000'></h3>
                                <img style="width: 200px;" src="https://kainoi.net/images/kai1.png">
                                ...
                                <?php
                                               ...
                                               if ($conn_rds->connect_error) {
                                                ...
                                                $sql = "select ELPROVINCE from tbanswer where RDSCODE = '" . $rdscode . "'";
                                                $result = $conn_rds->query($sql);
                                                $num_rows = mysqli_num_rows($result);
                                                $row = $result->fetch_assoc();
                                                $E1 =$row['ELPROVINCE'];
                                                
                                                if($CSBIOM == 2 and $E1 == 10){
                                                      echo "<input class=\"button button-primary button-winona wow fadeIn\" type=\"button\" value=\"ถัดไป\" onclick=\"window.location.href='outbkk.php'\">";
                                                }
                                                elseif($CSBIOM == 2 and $E1 == 50){
                                                    echo "<input class=\"button button-primary button-winona wow fadeIn\" type=\"button\" value=\"ถัดไป\" onclick=\"window.location.href='outbkk.php'\">";
                                                }
                                                elseif($CSBIOM == 1 and $E1 == 10){
                                                      echo "<input class=\"button button-primary button-winona wow fadeIn\" type=\"button\" value=\"ถัดไป\" onclick=\"window.location.href='inbkk.php'\">";
                                                }
                                                elseif($CSBIOM == 1 and $E1 == 50){
                                                      echo "<input class=\"button button-primary button-winona wow fadeIn\" type=\"button\" value=\"ถัดไป\" onclick=\"window.location.href='incm.php'\">";
                                               }else{     
                                                       echo "<input class=\"button button-primary button-winona wow fadeIn\" type=\"button\" value=\"ถัดไป\" onclick=\"window.location.href='outbkk.php'\">";
                                                  }
