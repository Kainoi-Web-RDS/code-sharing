    ...
    <!--
        ...
        <div class="container">
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2; opacity: 5; border-radius: 15px;" >
                              <h3><p class="thick" style="text-align: center;" >สำหรับคุณที่อยู่บริเวณเชียงใหม่</p></h3><br>
                                ...
                                <h5>หากคุณสนใจ โครงการมีรายชื่อสถานบริการ ตามที่ระบุไว้ด้านล่าง เพื่อให้คุณไปตรวจเลือดได้</h5><br>
                                  <img style="width: 300px;" src="https://kainoi.net/images/kai3-1.png">
                                   <p><h5><b style="color: #FF0000;"> "มูลนิธิเอ็มพลัส Mplus+  ศูนย์สุขภาพ แคร์แมท"</b><br>&nbsp;คลินิคที่อื่นๆต้องโทรนัดหมายดังรายละเอียดที่ให้ไว้ </h5></p>
                            ...
                            <div id="myDIV">
                                                ...
                                                <label class="containerins12">&nbsp;&nbsp;&nbsp;&nbsp;ยินยอมตรวจเลือดเพื่อตรวจหาการติดเชื้อเอชไอวี และไวรัสตับอักเสบ
                                                <input type="radio" name="isAgree" id="yesCheck"  value="1" onclick="javascript:yesnoCheck();"><br>
                                                 ...
                                                 <div id="ifyes" style="display:none" >
                                                    <div class="sec-sub-title text-center">
                                                        ...
                                                        <div class="contact-form" style="padding: 50px 0; background-color: #7FFFCC; margin-top: 20px; border-radius: 6px ; border: 3px solid #000000;padding: 5px;">
                                                               <p style="font-weight: bold;">เพื่อให้การบริการสะดวกและรวดเร็ว คุณสามารถทำการนัดตรวจเลือดกับเจ้าหน้าที่สถานบริการโดยตรง ตามวัน เวลาที่ได้กำหนดไว้ข้างล่างนี้</p>
                                                               <br>
                                                               ...
                                                               <div class="table-responsive" style="background-color: #fff;">
                                                                        <table class="table">
                                                                          ...
                                                                          <tbody>
                                                                            ...
                                                                            <tr>
                                                                            <td><label style="font-size: 16px; font-weight: bold; color:DodgerBlue;" class="containerins12">1.รพ.สารภี 
                                                                             <input type="radio" id="pins12a" name="pins" value="11">
                                                                             <span class="checkmarkins12"></span>
                                                                             </td>
                                                                             <td>จันทร์-ศุกร์ เวลาราชการ</td>
                                                                              <td>053-321179</td>
                                                                             </label>
                                                                            </tr>
                                                                           
                                                                           <tr>
                                                                            <td><label style="font-size: 16px; font-weight: bold; color:DodgerBlue;" class="containerins12">2.มูลนิธิเอ็มพลัส Mplus+
                                                                             <input type="radio" id="pins12b" name="pins" value="12">
                                                                             <span class="checkmarkins12"></span>
                                                                             </td>
                                                                              <td>จันทร์-ศุกร์ เวลา 13.00 - 19.00 น.</td>
                                                                              <td>เบอร์เมือถือ 086-9194840,086-9193432</td>
                                                                             </label>
                                                                            </tr>
                                                                         
                                                                            <tr>
                                                                            <td><label style="font-size: 16px; font-weight: bold; color:DodgerBlue;" class="containerins12">3.ศูนย์สุขภาพ แคร์แมท CAREMAT
                                                                             <input type="radio" id="pins12c" name="pins" value="13">
                                                                             <span class="checkmarkins12"></span>
                                                                             </td>
                                                                               <td>จันทร์-ศุกร์ เวลา 13.00 - 19.00 น.</td>
                                                                              <td>052-005-458 เบอร์เมือถือ 086-9102570</td>
                                                                             </label>
                                                                            </tr>
                                               ...
                                               <br>
                                            <label class="containerins12">&nbsp;&nbsp;&nbsp;&nbsp;ไม่ยินยอมตรวจเลือดเพื่อตรวจหาการติดเชื้อเอชไอวี และไวรัสตับอักเสบ
                                            <input type="radio" name="isAgree" id="noCheck" value="2" onclick="javascript:yesnoCheck();"><br>
                                            <span class="checkmarkins12"></span>
                                            </label>
                                              <div id="ifNo" style="display:none; background-color: #fff;" >
                                                    <ul  class="sec-title text-left" style="font-size: 20px; font-weight: bold; padding-top: 5px;">เพราะว่า :<br>
                                                      ...
                                                      <span class="checkmarkins12"></span>
                                                       ...
                                                       <br>
                                                       <button type='submit'   id='submit' class='btn btn-primary btn-lg'>ENTER</button></center>
                                                       <br><br>
                                      </form>
...
"type": "Feature",
"properties": {
"description": "<strong style='color:DodgerBlue;'>รพ.สารภี</strong>"
},
"geometry": {
"type": "Point",
"coordinates": [99.0430723, 18.6810155]
}
}, {
"type": "Feature",
"properties": {
"description": "<strong style='color:DodgerBlue;'>มูลนิธิเอ็มพลัส</strong>"

},
"geometry": {
"type": "Point",
"coordinates": [98.9792774, 18.762194]
}
}, {
"type": "Feature",
"properties": {
"description":"<strong style='color:DodgerBlue;'>ศูนย์สุขภาพ แคร์แมท CAREMAT</strong>"
},
"geometry": {
"type": "Point",
"coordinates": [98.9642115, 18.7889945]
}
}
]
}
 ...
 function fncSubmit()
{
    ...
    if( radio1.checked==false && radio2.checked==false ){
        ...
        return false;
            ...
            if(radio10.checked==false && radio11.checked==false && radio12.checked==false){
