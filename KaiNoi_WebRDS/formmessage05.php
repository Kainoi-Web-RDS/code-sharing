    ...
    <div class="page">
      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #FF0000;">
                                               </br>
                                                <h4><font color='#000000'>"ขอขอบคุณที่คุณให้ความสนใจในโครงการ kainoi.net และสละเวลาอันมีค่า"</font><br> </h4>
                                                <h4><font color='#000000'>"ขออภัยครับตอนนี้จำนวนผู้เข้าร่วมโครงการครบแล้ว"</font><br> </h4>
                               <br>
                               <center>
                                     <button type="button" name="button"  class="button button-primary button-winona wow fadeIn" onclick="window.location.href='index_hs.php'">กลับไปหน้าแรก</button>
                               </center>
        </div>
        </div>
          </span>
