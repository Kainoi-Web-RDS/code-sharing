 ...
 error_reporting( error_reporting() & ~E_NOTICE );
    // date_default_timezone_set("Asia/Bangkok");
                                 ...
                                 die("Connection failed: " . $conn_rds->connect_error);
                                   ...
                                   $sql_t100 = "select T100 from tbanswer where RDSCODE = '$rds_code' ";
...
if ($conn_rds->connect_error) {
 ...
 $sql = "select REGMOBILE, OTP_ACT_QUES  from tbanswer WHERE RDSCODE = '$rds_code' ";
...
<sms type=\"mt\">
<service-id>xxxxxxxxxxxxxxxxxxxxxxxxxxxx</service-id>
<destination>
		<address>
		<number type=\"international\">$new_moblie</number>
		</address></destination><source>
		<address>
		<number type=\"abbreviated\">xxxxxxxxxxxxxxxxxx</number>
		<originate type=\"international\">xxxxxxxxxxxxxxxxxxxxxxxx</originate>
        ...
        <div class="container">
          ...
          <div  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2; opacity: 5; border-radius: 15px;" >
                     ...
                     <h3><center>กรุณาระบุ OTP ที่ท่านได้รับ<br>เพื่อยืนยันตัวตนของคุณ</center></h3>
                                <form name="chkotpform" id="chkotpform" method="POST" action="screen.php" onSubmit="JavaScript:return fncSubmit();">
                                <!-- Trigger the modal with a button -->
                                  ...
                                  <center><span id="user-availability-status"></span></center>
                                   ...
                                   <center><button type='button'   id='back' class='button button-primary' style = 'display: none;' onclick="location.replace('index.php');" />กลับไปหน้าหลัก</button></center><br>
                                </form>
                       </h5>
                     <br>
             </div>
