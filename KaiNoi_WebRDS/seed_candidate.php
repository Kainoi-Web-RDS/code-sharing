...
<link href="https://fonts.googleapis.com/css2?family=Chakra+Petch:wght@400;500;700&display=swap" rel="stylesheet">
     ...
     <!-- <section class="section section-halfscreen bg-image" style="background-image: url(images/header-bg.jpg);">
      ...
      <section>
        <div  class="section section-lg text-center" style="padding: 0px;">
                <div class="container" style=" background: linear-gradient(-60deg, rgb(255, 131, 0) 0%, rgb(252, 164, 0) 0%, rgb(183, 73, 0) 100%);  border-radius: 6px ; border: 3px solid #000000;">
               <br>
               <!--<div class="container" >
              <div class="row">
              ...
              <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #000000;  margin-left: 10px; margin-right: 10px; padding:0px ">
                       ...
                       <form id="regForm" method="POST" action="seed_candidate_code.php">
  ...
  <fieldset class= "qs1"  >
      ...
      <span style="text-align: justify; white-space: pre;font-weight: bold;">คุณเห็นโฆษณา </span>
      <span style="text-align: justify; white-space: pre;font-weight: bold;">“เพียงแค่คุณ</span>
      <span style="text-align: justify;white-space: pre;font-weight: bold;">เป็นเพศชายอายุ</span>
      <span style="text-align: justify;white-space: pre;font-weight: bold;">15ปี ขึ้นไป </span>
      <span style="text-align: justify;white-space: pre;font-weight: bold;">ตอบแบบสำรวจรับ</span>
      <span  style=" color :#F40000; text-shadow: 1px 1px 2px orange;white-space: pre;font-weight: bold;"> บัตรทรูมันนี่ 200 บาท</span>
      <span style=" text-align: justify;white-space: pre;font-weight: bold;">และหากคุณ</span>
      <span style=" text-align: justify;white-space: pre;font-weight: bold;">ชวนเพื่อนรับ</span>
      <span style=" text-align: justify;white-space: pre;font-weight: bold;">เพิ่มอีกคนละ 50 บาท”</span>
      <span style=" text-align: justify;white-space: pre;font-weight: bold;">  มาจากไหน</span>
      
      <br>
      <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.	Blue’D<input type="radio" id="QPICYBLO_a" name="QPICYBLO" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.	Facebook Buddy station<input type="radio" id="QPICYBLO_b" name="QPICYBLO" value="2">
        <span class="checkmarkins12"></span></label>
        
        <label class="containerins12" style="text-align: left;">3. อื่นๆ ระบุ…<input type="radio" id="QPICYBLO_c" name="QPICYBLO" value="3">
        <span class="checkmarkins12"></span></label>

       <div id="ifNo1" style="display:none">
            โปรดระบุ <input style="padding-left: 8px;opacity: 5; border-radius: 20px; height: 35px;"  type="text" id="QPICYBLO_OTHER" name="QPICYBLO_OTHER">
       </div>
    ...
    <fieldset class= "qs1">
      <span style="text-align: left; white-space: pre; font-weight: bold;">คุณสนใจที่จะ</span>
      <span style="text-align: left; white-space: pre; font-weight: bold;">เข้าร่วมโครงการ</span>
      <span style="white-space: pre;font-weight: bold;">กับเราหรือไม่ครับ</span>
      
        <hr class="new">
			   <br>
       <label  class="containerins12" style="text-align: left;">1.	สนใจ<input type="radio" id="CANDINT_a" name="CANDINT" value="1">
        <span class="checkmarkins12"></span></label>
       
        <label class="containerins12" style="text-align: left;">2.	ไม่สนใจ<input type="radio" id="CANDINT_b" name="CANDINT" value="2">
        <span class="checkmarkins12"></span></label>
        
     <br><hr class="new">
         <br>
     <p>กรุณากดปุ่ม "ตกลง" ด้วยครับ</p>
     <br>
			  <input type="button" name="previous"  style="float: left;" class="previous action-button" value="ก่อนหน้า" />
	    	<button name="next"  class="next" style="float: right;" type="submit">ตกลง</button>
    ...
    <script src="js/script.js"></script>
    	...
    	case 0:
					...
					if(($("input[name='QPICYBLO']:checked").length === 0)){
					alert('กรุณาเลือกคำตอบ!');
						return false;
					}else if(document.forms["regForm"]["QPICYBLO_c"].checked  && document.forms["regForm"]["QPICYBLO_OTHER"].value == ""){
            ...
            return false;
				...
				case 1:
					if(($("input[name='CANDINT']:checked").length === 0)){
					alert('กรุณาเลือกคำตอบ!');
						return false;
					}
					return true;
 ...
 <script>
             ...
             $("#QPICYBLO_a").click(function(){
                $("#ifNo1").hide();$("#QPICYBLO_OTHER").val('');
             });
             $("#QPICYBLO_b").click(function(){
                  $("#ifNo1").hide();$("#QPICYBLO_OTHER").val('');
             });
              $("#QPICYBLO_c").click(function(){
                   $("#ifNo1").show("slow");
             });
