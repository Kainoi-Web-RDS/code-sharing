...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        ...
        <center><h3>
        <span style="text-align: justify; white-space: pre;font-weight: bold;">เจ้าหน้าที่ LAB</span>
         <span style="text-align: justify; white-space: pre;font-weight: bold;">โครงการ</span>
        <span style="text-align: justify; white-space: pre;font-weight: bold;">Kainoi เข้าสู่ระบบ</span>
                             ...
                             <form  name="formlogin" action="checklogin.php" method="POST" id="login" >
                               ...
                               <div class="form-group">
                                    <input type="text"  style="opacity: 5; border-radius: 15px;  width: 250px;height: 40px; font-size: 16px; text-align: center;"   name="usernamel" class="form-control" required placeholder="Username" />
                                   <input type="password"  style="opacity: 5; border-radius: 15px;  width: 250px;height: 40px; font-size: 16px; text-align: center;"  name="passwordl" class="form-control" required placeholder="Password" />
                               </div>
                               <div class="form-group">
