...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        ...
        <br>
        <br>
          <center><h2><b style="color: #FF0000;"></b>หมายเลข LABNUMBER :&nbsp;<font color='#F74C58'><?php echo $LABNUMBER; ?></font>&nbsp;นี้มีในระบบแล้ว<?php unset($_SESSION["LABNUMBER"]); ?></h2></center> <br>
           <center>
           <button type="button" name="button"  class="buttong" onclick="window.location.href='result.php'">กลับไปหน้าหลัก</button>
           </center>
         </div>
        <br>
        <br>
