...
<body class="top-header">
    ...
    <section class="bg-grey" id="service">
        ...
        <br>
        <br>
          <center><h2>LAB :kainoi.net หมายเลข<b style="color: #FF0000;"><?php echo $LABNUMBER; unset($_SESSION["$LABNUMBER"]); ?> </b>บันทึกผลการตรวจเข้าระบบเรียบร้อย </h2></center> <br>
           <center>
           <button type="button" name="button"  class="buttong" onclick="window.location.href='selects.php'">กลับไปหน้าแรก</button>
           </center>
         </div>
        <br>
        <br>
