    ...
    <section class="bg-grey" id="service">
       ...
       <input type="submit" class="btn btn-danger" style="opacity: 5; border-radius: 20px;" value="ออกจากระบบ">
        ...
        <center><h3>เจ้าหน้าที่โปรดเลือก ดังนี้</h3></center>
            <div class="row ">
                <div class="col-lg-6">
                            <a href="result.php"><div class="service-content"   <div class="container" style=" background: linear-gradient(-60deg, rgb(0, 144, 255) 0%, rgb(0, 204, 249) 0%, rgb(255, 255, 255) 100%); opacity: 5px;  border-radius: 20px ; border: 3px solid #000000;">
                           <center><font color='#3E3C3A'><h2>เจ้าหน้าที่LAB<br>
                                   คีย์ผลการตรวจ</h2></font>
                           	<img width="150px" src="assets/img/kai3-1.png"></a>
             ...
             <div class="col-lg-6">
                         <a href="../clinic/caseresult.php"><div class="service-content"   <div class="container" style="  background: linear-gradient(60deg, rgb(1, 147, 40) 0%, rgb(0, 247, 90) 0%, rgb(255, 255, 255) 100%); opacity: 5px;  border-radius: 20px ; border: 3px solid #000000;">
                           <center><font color='#3E3C3A'><h2> ค้นหา ผลการตรวจ <br>"<?php echo $hos_name; ?>"</h2></font>
