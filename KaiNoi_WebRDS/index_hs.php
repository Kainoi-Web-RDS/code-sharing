...
if(isset($_COOKIE[$cookie_rds])) {
	if($_COOKIE[$cookie_rds] == "thailand2019_screen" ){
		echo "<script>";
       echo "window.location='formmessage016.php'";
    echo "</script>";
	...
	<!-- Modal ปิดปรับปรุง server -->
			...
			<div id="destimg">
				<?php
				  if ($conn_rds->connect_error) {
                        die("Connection failed: " . $conn_rds->connect_error);
                                                                    ...
                                                                    $sql = "SELECT ISSEED FROM tbanswer where ISSEED = 'seed'";
                                        ...
                                        If($num_rows < 100)//+1
                                        {
																				 echo 	"<a href='seed_candidate.php'><img class='topimg' src='images/3368748-1-8.gif' style='width:100%;height: auto;'>";
																				}
																				else
																				{
				...
				?>
					 ...
					 <!-- <a href="seed_candidate.php"><img class="topimg"  src="images/3368748-1-8.gif" style="width:100%;height: auto;">
				 ...
				 <?php
				  if ($conn_rds->connect_error) {
                        die("Connection failed: " . $conn_rds->connect_error);
                                        ...
                                        If($num_rows < 100)
                                        {
																				 echo 	"<a href='seed_candidate.php'><img class='topimg' src='images/3368748-1-square-8.gif' style='width:100%;height: auto;'>";
																				}
																				else
																				{
																				 echo 	"<a href='formmessage06.php'><img class='topimg' src='images/3368748-1-square-8.gif' style='width:100%;height: auto;'>";
																				}
				?>
					   					 <!-- <a href="seed_candidate.php"><img class="topimg" src="images/3368748-1-square-8.gif" style="width:100%;height: auto;">
									...
									<div class="member-img imgbox" style ="background-color :#ffffff; border-style: groove; border-color: #c6c6c6;opacity: 5; border-radius: 20px;">
										...
										<div class="team-socials" style="margin-bottom: -70px;padding: 5px;"> 
											<p style="background-color: #ffffff; border-radius: 5px; padding: 3px 3px; font-size: 22px; ">
												...
												<span style="color: red;font-weight: bold;">true money 50 บาท</span>&nbsp;ภายใน 14วัน<br><!--ทันที -->
												เพื่อนได้ &nbsp;<span style="color: red;font-weight: bold;">200 บาท</span>&nbsp;ภายใน 14วัน</p>
										</div>
									</div>									
			      ...
			      <div class="modal-content" style="height: unset;">
			        ...
			        <div class="modal-body">
			          <h3 style="text-align: center;">
									...
									ตอบแบบสอบถามเรียบร้อย <br>
									เราได้บัตรเงินสด&nbsp;<br>
									<font color="red"><b>true money 50 บาท</b></font>&nbsp;ทันที <br>
									เพื่อนได้ &nbsp;<font color="red" ><b>200 บาท</b></font>&nbsp;ทันที</h3>
			        </div>
			      </div>
			    </div>
			  </div>
