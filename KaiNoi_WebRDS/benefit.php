  ...
  <body>
    <div class="page">
      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
          <h3 class="wow-outer"><span class="wow slideInUp"><br></span>สิ่งที่ผู้เข้าร่วมโครงการจะได้รับ </h3>
          <p class="wow-outer"><span class="text-width-1 wow slideInDown">
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #64B2EA;">
                                               </br>
                                                <h4><font color='#000000'>ผู้เข้าร่วมโครงการไม่ต้องเสียค่าใช้จ่ายอะไรเลย เราจะส่งรหัสบัตรเงินสดทรูมันนี่มูลค่า 200 บาทให้คุณทันทีผ่านระบบเมื่อคุณตอบแบบสอบถามออนไลน์เสร็จสมบูรณ์ และหากเพื่อนที่คุณชวนมีคุณสมบัติผ่านเกณฑ์เข้าร่วมโครงการและได้ตอบแบบสอบถามเสร็จสมบูรณ์แล้ว </font><br> </h4>
                                                <h4><font color='#000000'>เราจะส่งรหัสบัตรเงินสดทรูมันนี่มูลค่า 50 บาท ต่อเพื่อนของคุณเข้าร่วมโครงการ 1 คนให้กับคุณ (มากที่สุด 3 คน)</font><br> </h4>
                               <br>
