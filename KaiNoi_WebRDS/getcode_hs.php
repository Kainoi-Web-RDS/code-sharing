  ...
  <body>
    <div class="page">
      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
         <br><br>
        <h3 class="wow-outer" style ="background-color :#ffffff; border-style: groove; border-color: #1370F2; opacity: 5; border-radius: 5px;">
         <span class="wow slideInUp"  style ="padding: 8px 8px;">พวกเรายินดีอย่างยิ่งครับ ที่คุณให้ความสนใจที่จะเข้าร่วมโครงการ</span></h3>
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2;">
                               ...
                               <center>
                                 ...
                                 <img style="width: 300px;" src="https://kainoi.net/images/kai2-1.png">
                                   <form  name="ReqCheckRDSCode" method="post" action="checkcode_hs.php" onSubmit="JavaScript:return fncSubmit();">
                                   <div class="table-responsive">
                                   <table class="table">

                                         <tbody>
                                           <tr>
                                             <td style= "text-align:center;" >กรุณาป้อนเบอร์โทรศัพท์:</td>
                                             <td><input style="opacity: 5; border-radius: 15px;  width: 100px;height: 40px; font-size: 14px; text-align: center;" type="phone" class="event-details"  maxlength="10"  name="mobilephone" id="mobilephone" ></td>
                                            <td style= "text-align:center; " >ตัวอย่าง 08XXXXXXXX</td>
                                           </tr>
                                         </tbody>
                                       </table>
                                   </div>
                                             <button type="submit" value="Check" name="button1" id="submit" class="button button-primary button-winona wow fadeIn  button-block">ตกลง</button>
                                             <button type="button" name="button2"  class="button button-primary button-winona wow fadeIn button-block button-block" onclick="window.location.href='not_coupon_interestcode.php';" >กลับไปหน้าหลัก</button>
                                   </form></h4>
                                 </div>               
                               </center>
        </div>
