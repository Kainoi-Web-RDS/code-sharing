      ...
      <div class="tabs-horizontal"></div>
        ...
        <div class="container">
          ...
          <div class="jumbotron"  style ="background-color :#ffffff; border-style: groove; border-color: #1370F2;">
                                                ...
                                                <h4>คุณมีคุณสมบัติในการเข้าร่วม kainoi.net เพียงให้คำยินยอมและตอบแบบสอบถาม<br> </h4>
                                                <h4>คุณจะได้รับ<br>
                                                <b style="color: #FF0000;">ค่าชดเชยเป็นรหัสบัตรทรูมันนี่</b><br>
                                                                 ทันทีครับ</h4><br>
                                                <img style="width: 200px;" src="https://kainoi.net/images/kai6_1-1.png">
                               <br>
                               <center>
                                     <button type="button" name="button"  class="button button-primary button-winona wow fadeIn" onclick="window.location.href='consent.php'">ถัดไป</button>
                               </center>
        </div>
        </div>
          </span>
